...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sumtypes-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14271&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sumtypes-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sumtypes` can be installed with:

```
conda install sumtypes
```

It is possible to list all of the versions of `sumtypes` available on your platform with:
